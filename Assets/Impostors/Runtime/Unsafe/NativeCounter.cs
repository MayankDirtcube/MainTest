///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// From https://docs.unity3d.com/Packages/com.unity.jobs@0.1/manual/custom_job_types.html in 'Custom NativeContainers' section.
//
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public NativeCounter(Allocator label)
        {
            ...
            if (!UnsafeUtility.IsBlittable<int>())
                throw new ArgumentException(
                    string.Format("{0} used in NativeCounter<{0}> must be blittable", typeof(int)));
#endif
