...
namespace Impostors.Editor
{
    ...
    internal class ImpostorLODGroupEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("This component will override attached LODGroup component on startup.",
            ...
            if (m_NumberOfImpostorLODs > 0 && activeLOD >= 0)
            {
            ...
            var lods = LODGroupGUI.CreateLODInfos(
                ...
                i => m_LODGroup.GetLODs()[i].screenRelativeTransitionHeight);
            ...
            lods = LODGroupGUI.CreateLODInfos(
                ...
                sliderBarPosition,
                i => i == 0 ? "Original object" : string.Format("Impostor {0}", i - 1),
        ...
        private void DrawHelpBoxAboutUnassignedRenderers()
        {
            ...
            var impostorLodGroupRenderers = m_ImpostorLODGroup.LODs.SelectMany(lod => lod.renderers).ToArray();
