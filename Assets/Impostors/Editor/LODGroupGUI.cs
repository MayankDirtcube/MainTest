...
namespace Impostors.Editor
{
    internal static class LODGroupGUI
    {
        ...
        public class GUIStyles
        {
            ...
            public readonly GUIContent m_CameraIcon                         = EditorGUIUtility.TrIconContent("Camera Icon");//EditorGUIUtility.IconContent<Camera>(); //CHANGED
        ...
        public static List<LODInfo> CreateLODInfos(int numLODs, Rect area, Func<int, string> nameGen, Func<int, float> heightGen)
        {
            ...
            for (int i = 0; i < numLODs; ++i)
            {
                ...
                var previousPercentage = i == 0 ? 1f : lods[i - 1].ScreenPercent;
        ...
        public static void DrawLODSlider(Rect area, IList<LODInfo> lods, int selectedLevel, bool interactable)
        {
